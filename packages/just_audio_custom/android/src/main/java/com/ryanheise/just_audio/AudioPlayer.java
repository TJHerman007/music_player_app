...
import com.ryanheise.just_audio.AudioPlayer.ObserverRenderer;
...
public class AudioPlayer implements MethodCallHandler, Player.Listener, MetadataOutput {
    ...
    protected AudioSink buildAudioSink(
        ...
        RenderersFactory finalRenderersFactory =
                (eventHandler,
                 videoListener,
                 audioListener,
                 textOutput,
                 metadataOutput) -> {
                    ...
                    Renderer[] allRenderers =
                            Arrays.copyOf(
                                    defaultRenderers,
                                    defaultRenderers.length + 1
                            );

                    allRenderers[defaultRenderers.length] =
                            new ObserverRenderer();
        ...
        if (livePlaybackSpeedControl != null) {
            builder.setLivePlaybackSpeedControl(
